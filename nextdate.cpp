...
TEST(nextDate, nonleapYearChangeFebDay) {
    EXPECT_STREQ(nextDate(2, 28, 2001), "3, 1, 2001");
    EXPECT_STREQ(nextDate(2, 28, 2003), "3, 1, 2003");
    EXPECT_STREQ(nextDate(2, 28, 2005), "3, 1, 2005");
    EXPECT_STREQ(nextDate(2, 28, 2100), "3, 1, 2100");
}
